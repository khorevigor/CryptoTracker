...
import com.plcoding.cryptotracker.crypto.presentation.coin_details.line_chart.ValueLabel
...
fun ChartStyle(
    ...
    selectedColor: Color,
    helperLinesThicknessPx: Float,
    axisLinesThicknessPx: Float,
    labelFontSize: TextUnit,
    minYLabelSpacing: Dp,
    verticalPadding: Dp,
    horizontalPadding: Dp,
    xAxisLabelSpacing: Dp
) {
